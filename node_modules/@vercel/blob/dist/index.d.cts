import { j as CommonCreateBlobOptions, W as WithUploadProgress, O as OptimizeImageOptions, k as BlobError, a as BlobCommandOptions, B as BlobAccessType, P as PutBlobResult, f as PutBody, e as Part, l as CompleteMultipartUploadCommandOptions, U as UploadPartCommandOptions } from './create-folder-BM6BTlko.cjs';
export { b as BlobClientTokenConstraintOptions, m as CreateFolderCommandOptions, n as CreateFolderResult, D as DelegationOperation, d as IssueSignedTokenOptions, I as IssuedSignedToken, o as OnUploadProgressCallback, p as PartInput, q as PresignDeleteUrlOptions, r as PresignGetUrlOptions, s as PresignHeadUrlOptions, c as PresignPutUrlOptions, t as PresignUrlOptions, u as PresignUrlResult, g as PresignedUrlPayload, v as UploadProgressEvent, i as createFolder, w as getDownloadUrl, x as issueSignedToken, y as parseStoreIdFromDelegationToken, z as parseStoreIdFromPresignedUrl, A as presignUrl } from './create-folder-BM6BTlko.cjs';
...
type RenameCommandOptions = CommonCreateBlobOptions;
interface RenameBlobResult {
    url: string;
    downloadUrl: string;
    pathname: string;
    contentType: string;
 ...
 */
declare function rename(fromUrlOrPathname: string, toPathname: string, options: RenameCommandOptions): Promise<RenameBlobResult>;

interface PutImageCommandOptions extends Omit<CommonCreateBlobOptions, 'contentType'>, WithUploadProgress {
    /**
...
type PutImageBlobResult = PutBlobResult;
/**
 ...
 */
declare function putImage(pathname: string, bodyOrUrl: PutBody | URL, options: PutImageCommandOptions): Promise<PutImageBlobResult>;

/** @deprecated Use `putImage` and `PutImageCommandOptions` instead. */
interface PutFromUrlCommandOptions extends Omit<CommonCreateBlobOptions, 'contentType'> {
    /**
     * Optimize the image through Vercel Image Optimization before storing it.
...
type PutFromUrlBlobResult = PutBlobResult;
/**
 ...
 */
declare function putFromUrl(pathname: string, url: string, options: PutFromUrlCommandOptions): Promise<PutFromUrlBlobResult>;
...
export { BlobAccessError, BlobAccessType, BlobClientTokenExpiredError, BlobContentTypeNotAllowedError, BlobError, BlobFileTooLargeError, BlobNotFoundError, BlobPathnameMismatchError, BlobPreconditionFailedError, BlobRequestAbortedError, BlobServiceNotAvailable, BlobServiceRateLimited, BlobStoreNotFoundError, BlobStoreSuspendedError, BlobUnknownError, CompleteMultipartUploadCommandOptions, type CopyBlobResult, type CopyCommandOptions, type DeleteCommandOptions, type GetBlobResult, type GetCommandOptions, type HeadBlobResult, type ListBlobResult, type ListBlobResultBlob, type ListCommandOptions, type ListFoldedBlobResult, OptimizeImageOptions, Part, PutBlobResult, type PutCommandOptions, type PutFromUrlBlobResult, type PutFromUrlCommandOptions, type PutImageBlobResult, type PutImageCommandOptions, type RenameBlobResult, type RenameCommandOptions, UploadPartCommandOptions, completeMultipartUpload, copy, createMultipartUpload, createMultipartUploader, del, get, head, list, put, putFromUrl, putImage, rename, uploadPart };
