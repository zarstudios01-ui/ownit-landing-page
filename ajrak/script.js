const state = { model: 'PS5 Disc', coverage: 'Console Only', price: 1500, qty: 1, cart: 0 };
  ...
  document.getElementById('bundleAddBtn').addEventListener('click', () => {
    window.OwnItCart.addToCart({ id:'ajrak-controller', name:'Ajrak Controller Skin', variant:'Controller Only', price:500, image:'/images/product-ajrak-controller.jpg', qty:1 });
  });
